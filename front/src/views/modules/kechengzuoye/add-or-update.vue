    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="作业详情" prop="zuoyexiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zuoyexiangqing" label="作业详情" prop="zuoyexiangqing">
                    <span v-html="ruleForm.zuoyexiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zuoyexiangqing = this.ruleForm.zuoyexiangqing.replace(reg,'../../../springboot59b1w/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
